                  ...
                  {selectedGroup?.id === g.id && (
                    <div style={{ marginTop: 10, display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8 }}>
                      {[
                        ...
                        ['Data Erezione', g.data_erezione],
                        ['N. Aggregazione', g.numero_aggregazione],
                        ['Data Aggregazione', g.data_aggregazione_originale],
                        ['Opera', g.opera || '—'],
                        ['Congregazione', g.congregazione || '—'],
                        ['Diocesi', g.diocesi || '—'],
                        ['Ispettoria', g.ispettoria || '—'],
                        ['Presidente', g.nome_presidente ? `${g.nome_presidente} ${g.cognome_presidente}` : '—'],
